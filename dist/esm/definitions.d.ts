...
export declare type ApplePayCode = 'missing_merchant_id' | 'missing_amount' | 'missing_url' | 'missing_body' | 'missing_session_in' | 'invalid_amount' | 'invalid_country_code' | 'invalid_currency_code' | 'invalid_networks' | 'empty_supported_networks' | 'empty_items' | 'payment_authorized' | 'payment_reject' | 'session_canceled' | 'session_failed' | 'request_failed' | 'applepay_not_available' | 'paymentsheet_problem_opening' | 'paymentsheet_problem_closing' | 'applepay_error' | 'uknown_error';
/**
